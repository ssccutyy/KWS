...
data_aishell=/home/sudi/corpus/aishell/data
...
EOF
	...
	utils/prepare_lang.sh --position-dependent-phones false $data_local_dict "<GBG>" data/local/lang data/lang
...
# align
if [ $stage -le 6 ];then
    steps/align_si.sh --cmd "$train_cmd" --nj 40 \
...
if [ $stage -le 11 ];then
	best_result=$(cat exp/chain/tdnn_1b_kws/decode_test_new/scoring_kaldi/best_wer)
